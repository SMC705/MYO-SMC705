...
public:
    ...
    // This function takes the position values from the quaternion and assign new values to roll_, pitch_w and yaw_w every time new data are provided by the Myo.
